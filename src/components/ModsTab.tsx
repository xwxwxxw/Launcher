      ...
      <div className="bg-[#09090b]/95 backdrop-blur-sm border-b border-zinc-800/60 p-6 pt-8 flex flex-col gap-6 flex-shrink-0 z-10 relative">
        ...
        <div className="flex items-end justify-between">
          <div>
            <div className="flex items-center gap-3">
              ...
              {loading && <RefreshCw size={12} className="animate-spin text-purple-400" />}
            </div>
          ...
          <div className="flex gap-2 flex-wrap justify-end">
            ...
            <button 
              ...
              disabled={updating}
              className="bg-purple-500/10 hover:bg-purple-500/20 border border-purple-500/20 hover:border-purple-500/30 px-4 py-2.5 rounded-xl flex items-center gap-2 text-[10px] uppercase tracking-widest font-bold text-purple-400 transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <div className="relative w-72">
            ...
            <input 
              ...
              className="w-full bg-zinc-950/50 border border-zinc-800/60 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 outline-none transition-all placeholder:text-zinc-600 font-medium"
            />
          </div>
        </div>
        ...
        {contentType === 'mods' && (
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <FilterTag active={fClient} onClick={() => setFClient(!fClient)} label="Клиент" color="text-purple-400" dotColor="bg-purple-400" />
      ...
      <div className="flex-1 min-w-0 relative z-10">
        ...
        <div className="flex flex-wrap gap-2 my-3">
          ...
          {contentType === 'mods' && (
            <>
              ...
              {mod.is_client && <Badge label="Клиент" color="border-purple-500/30 bg-purple-500/10 text-purple-400" />}
        ...
        {contentType === 'mods' && (
          <div className="flex items-center justify-between pt-2 border-t border-zinc-800/50">
            ...
            <button onClick={onShowDeps} className="text-[10px] uppercase tracking-widest font-bold text-purple-400 hover:text-purple-300 transition-colors">
              Граф зависимостей
            </button>
          </div>
        )}
